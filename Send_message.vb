...
Public Class Send_message
    ...
    Dim i As Integer
    Dim st As String
    Private Sub Send_message_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not re2.IsMatch(TextBox3.Text) Then
        ...
        s = "insert into ContactUs_Message values('" & TextBox1.Text & "','" & TextBox3.Text & "','" & TextBox2.Text & "')"
